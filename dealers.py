...
COMPARE = [
    ...
    # 基板（浜屋・ケイワイ・大畑）
    ("基板／クラス", "基板SS", ["基板SS", "ＳＳクラス基板", "SSランク基板"]),
    ("基板／クラス", "基板S", ["基板Ｓ", "Ｓクラス基板", "S基板"]),
    ("基板／クラス", "基板A", ["基板A(両面実装)", "Ａクラス基板", "A基板"]),
    ("基板／クラス", "基板B", ["基板B(片面実装)", "Ｂクラス基板", "B基板"]),
    ("基板／クラス", "基板C", ["基板C(ノートPC)", "Ｃクラス基板", "C基板"]),
    ("基板／クラス", "基板D", ["基板D(長方形チップ少)", "Ｄクラス基板"]),
    ("基板／クラス", "電源基板", ["電源基板A(電源1)", "電源基板(鉄なし)", "内蔵電源"]),
    ("基板／クラス", "家電基板", ["家電基板", "家電基板A(緑・青)"]),
    ("基板／クラス", "金メッキ基板(厚金)", ["金メッキプリント基板厚金", "金メッキプリント基板（厚金）"]),
    ("基板／クラス", "チューナー基板", ["チューナー基板(上)", "チューナー基板"]),
    ("基板／クラス", "生基板", ["生基板"]),

    ("基板／CPU・IC", "CPUセラ(上)", ["ＣＰＵセラＳ（両面金）", "ＣＰＵセラ異物なし", "CPU-SS", "CPUセラミック（紫）"]),
    ("基板／CPU・IC", "CPU黒", ["ＣＰＵプラ黒", "ＣＰＵブラック", "CPU(黒)"]),
    ("基板／CPU・IC", "CPU緑(下)", ["ＣＰＵプラB(金属板有り)", "ＣＰＵグリーン（下）", "CPU(緑)"]),
    ("基板／CPU・IC", "IC正方形", ["ＩＣチップ正方形ミックス", "ＩＣ（正方形混合）", "IC(正方形)"]),
    ("基板／CPU・IC", "IC長方形", ["ＩＣチップ長方形ミックス", "ＩＣ（長方形混合）", "IC(長方形)"]),
    ("基板／CPU・IC", "CPUセラ長方形(金足)", ["ＣＰＵセラＳ（長方形金）", "ＣＰＵセラ長方形（金足）",
                                        "IC(長方形,セラミック,紫,金足)"]),
    ("基板／CPU・IC", "CPUセラ(金属板なし)", ["ＣＰＵセラA（金属板無し）", "ＣＰＵセラＡＭＤ"]),
    ("基板／CPU・IC", "CPUセラ(金属板あり)", ["ＣＰＵセラB(金属板有り)", "ＣＰＵブラック"]),
    ("基板／CPU・IC", "CPU緑(上)", ["ＣＰＵプラA（金属板無し）", "ＣＰＵグリーン（上）"]),

    ("基板／PC部品", "PCメモリー", ["ＰＣメモリー基板", "メモリー", "パソコン用メモリーA"]),
    ("基板／PC部品", "マザーボード", ["らくマザーA", "マザーボード（Ａ）", "パソコン用マザーボード"]),
    ("基板／PC部品", "ノートPCマザー(下)", ["らくマザーC", "マザーボードノート（下）"]),
    ("基板／PC部品", "HDD基板", ["HDD制御基板", "ＨＤＤ基板"]),
    ("基板／PC部品", "PCカード", ["PCカード基板", "ＰＣカード", "PCカード"]),
    ("基板／PC部品", "デスクトップPC", ["デスクトップPC", "パソコン屑(デスクトップPC,ノートPC)"]),
    ("基板／PC部品", "拡張カード(上)", ["ＰＣ拡張基板Ａ", "拡張カード（Ａ）"]),
    ("基板／PC部品", "拡張カード(下)", ["ＰＣ拡張基板Ｂ", "拡張カード（Ｂ）"]),
    ("基板／PC部品", "ノートPC基板", ["ノートＰＣ基板", "マザーボードノート（上）", "ノートPCマザーボードMIX"]),
    ("基板／PC部品", "HDD本体", ["ＨＤＤ本体", "HDD本体", "ハードディスク"]),

    ("基板／機器", "携帯電話基板", ["携帯電話基板"]),
    ("基板／機器", "携帯電話(電池なし)", ["携帯電話（電池なし）", "携帯電話本体(電池無)", "携帯電話本体（電池なし）", "携帯電話本体"]),
    ("基板／機器", "スマートフォン", ["スマートフォン", "スマートフォン（電池なし）", "スマートフォン本体"]),
    ("基板／機器", "リレー", ["リレー(接点付き)", "リレー混合"]),
    ("基板／機器", "携帯電話(電池あり)", ["携帯電話（電池あり）", "携帯電話本体（電池付き）"]),
    ("基板／機器", "デジカメ", ["デジカメ・デジタルビデオカメラ", "デジカメ（電池なし）",
                              "デジタルカメラ"]),
    ("基板／機器", "リチウムイオン電池", ["リチウムイオン電池"]),
...
SORT_BY_PRICE = {"基板／クラス", "基板／CPU・IC", "基板／PC部品", "基板／機器"}
